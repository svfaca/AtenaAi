...
export class Logger {
  ...
  static currentLevel = (typeof window !== 'undefined' && window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1')
    ? this.levels.WARN 
    : this.levels.DEBUG;
...
export default { AppError, AuthError, ValidationError, NetworkError, Logger };
